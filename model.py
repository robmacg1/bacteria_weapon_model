...
class Model:
    ...
    def run(self):
        ...
        self.figure.clear()
        density_map = [[float(0) for i in range(500)] for j in range(500)]
        #print(density_map)
        ...
        for i in range(no_particles):
            particles.append(bacteria.Bacteria(i, density_map, direction, altitude, bomb_loc[1], bomb_loc[0]))
        # for i in particles:
        #     print(i)    
    ...
    def get_winddirection(self):
        ...
        """
        # Gets slider value for North/South and derives how close it is to south and how far it is from south
        s = self.slider2.get()
        n = 100 - s
